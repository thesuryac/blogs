...
export default function UpadatePost() {
    ...
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-4 items-center justify-between">
                <FileInput type="file" accept="image/*" className="w-full" onChange={(e)=>setFile(e.target.files[0])} />
            ...
            <ReactQuill theme="snow" placeholder="Write something" className="h-72 mb-12" value={formData.content} required onChange={(value)=>setFormData({...formData,content:value})}/>
