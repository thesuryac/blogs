    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
        ...
        <div className="flex-1">
            ...
            </div>
            {
                isEditing ? (
                    ...
                    <div className="flex justify-end gap-2 text-xs mt-2">
                        ...
                        <Button onClick={()=> setIsEditing(false)} type='button' size="sm" outline gradientDuoTone="purpleToBlue">
                            Cancel
                        </Button>
                    </div>
                    </>
            ...
            <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
                <button className={`text-gray-400 hover:text-blue-500 ${currentUser && comment.likes.includes(currentUser._id)}`} onClick={()=>{onLike(comment._id)}}>
