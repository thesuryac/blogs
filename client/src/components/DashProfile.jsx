...
export default function DashProfile() {
    ...
    const uploadImage=async()=>{
        ...
        (error) =>{
            setImageFileUploadError("could no upload image (file must be less than 2MB");
    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form action="" className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <div className="relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full" onClick={()=>filePickerRef.current.click()}>
                ...
                <img src={imageFileUrl || currentUser.profilePicture} alt='user' className={`absolute top-0 left-0 rounded-full w-full h-full object-cover border-8  border-[lightgray] ${imageFileUploadingProgress && imageFileUploadingProgress<100 && "opacity-60"}`} />
            </div>
